...
export function QuestMapClient({ tracks, subtracks, quests, userProgress }: QuestMapClientProps) {
  const [expandedTracks, setExpandedTracks] = useState<Set<string>>(() => {
    // Auto-expand first track
    return new Set(tracks.length > 0 ? [tracks[0].id] : [])
  })
